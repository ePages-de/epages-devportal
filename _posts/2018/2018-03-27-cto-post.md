...
This flexibility is also secured by our development infrastructure.
For one thing, we decoupled frontend and backend into several Scrum teams.
Secondly, we organized functions around capabilities, which means that XXX.
- to enforces a modular structure
...
Working with open source frameworks rounds it off, as they allow us to “stand on the shoulders of giants”.
