...
{% image_custom image="/assets/img/pages/blog/images/restdocs-raml-raml2html.png" width="50" caption="raml2html_output" lightbox %}
...
{% image_custom image="/assets/img/pages/blog/images/restdocs-raml-api-console.gif"  width="50" caption="api_console" lightbox  %}
