...
This lead us to a [Consul](https://www.consul.io/)-based service discovery approach that we already talked about in detail [earlier on this blog](/blog/tech-stories/service-discovery-with-consul-registrator-and-haproxy/).
